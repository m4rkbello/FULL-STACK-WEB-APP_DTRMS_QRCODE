        ...
        <div className="card shrink-0 w-full shadow-md bg-gradient-to-r from-emerald-500 via-sky-500 to-violet-700  border-t-8 border-b-8 border-white">
          <form className="card-body">
            <div className="text-center">
              <h1 className="text-4xl sm:text-5xl font-bold text-white pt-8 sm:pt-10 pb-2">
                DTRMS+
              </h1>
            </div>
            <div className="form-control">
              ...
              <label className="input input-bordered flex items-center gap-2 glass">
                <input
                  ...
                  className="grow bg-white text-white placeholder-white"
                  placeholder="Email"
                />
              </label>
            </div>
            ...
            <div className="form-control">
              ...
              <label className="input input-bordered flex items-center gap-2 glass">
                <input
                  ...
                  type="password"
                  className="grow text-white placeholder-white"
              ...
              <label className="label">
                <a
                  href="#"
                  className="label-text-alt link link-hover text-white text-sm sm:text-lg"
                >
                  Forgot password?
                </a>
              </label>
            ...
            {/**
              ...
              */}
              <button
              onClick={handleLoginRequestAndResponse}
           className="btn drop-shadow-2xl glass bg-gradient-to-r from-white to-sky-500 hover:from-white hover:to-violet-700 text-black text-xl sm:text-2xl"
            >
                Login
              </button>
            </div>
