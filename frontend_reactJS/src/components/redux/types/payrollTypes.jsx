...
//SEARCH PAYROLL
export const SEARCH_PAYROLL_REQUEST = 'SEARCH_PAYROLL_REQUEST';
export const SEARCH_PAYROLL_SUCCESS = 'SEARCH_PAYROLL_SUCCESS';
export const SEARCH_PAYROLL_FAILURE = 'SEARCH_PAYROLL_FAILURE';
