...
//SEARCH RATE
export const SEARCH_RATE_REQUEST = 'SEARCH_RATE_REQUEST';
export const SEARCH_RATE_SUCCESS = 'SEARCH_RATE_SUCCESS';
export const SEARCH_RATE_FAILURE = 'SEARCH_RATE_FAILURE';
